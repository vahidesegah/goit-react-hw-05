...
const mt = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  me = "0123456789",
  Be = { DIGIT: me, ALPHA: Y, ALPHA_DIGIT: Y + Y.toUpperCase() + me },
...
const Ut = (e) => {
  ...
  Bt = C("AsyncFunction"),
  Dt = (e) => e && (X(e) || x(e)) && x(e.then) && x(e.catch),
  De = ((e, t) =>
    e
      ? setImmediate
      : t
      ...
      d.push(p),
        a.forEach(p, function (g, R) {
          (!(a.isUndefined(g) || g === null) &&
            s.call(t, g, a.isString(R) ? R.trim() : R, y, b)) === !0 &&
            E(g, y ? y.concat(R) : [R]);
        }),
        d.pop();
    }
...
const He = {
  ...
  Jt = {
    isBrowser: !0,
    classes: { URLSearchParams: Ht, FormData: zt, Blob: vt },
  ...
  Wt = (fe && window.location.href) || "http://localhost",
  Kt = Object.freeze(
...
const Ve = (e) => {
    ...
    (t.headers = i = A.from(i)),
      (t.url = Me($e(t.baseURL, t.url), e.params, e.paramsSerializer)),
      c &&
        i.set(
          "Authorization",
          "Basic " +
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        "onloadend" in h
          ...
          u && (([b, p] = $(u, !0)), h.addEventListener("progress", b)),
          f &&
            h.upload &&
            (([d, E] = $(f)),
  ...
  bn = async function* (e, t) {
    for await (const n of wn(e)) yield* yn(n, t);
  },
  wn = async function* (e) {
  ...
  We = Q && typeof ReadableStream == "function",
  gn =
    Q &&
  ...
  Te = 64 * 1024,
  ie = We && Ke(() => a.isReadableStream(new Response("").body)),
...
const Rn = async (e) => {
  ...
  On =
    ...
    (async (e) => {
      ...
      let E = mn([s, o && o.toAbortSignal()], i),
        p;
      const y =
        E &&
        E.unsubscribe &&
      ...
      try {
        ...
        u = u || "text";
        let P = await V[a.findKey(V, u) || "text"](R, e);
        return (
          !S && y && y(),
  ...
  Xe = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !Tn(n) && ((r = ae[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
function xe(e) {
  return (
    ...
    Xe.getAdapter(e.adapter || M.adapter)(e).then(
      function (r) {
        return (
          ne(e),
...
const J = { assertOptions: An, validators: Z },
  N = J.validators;
class U {
  constructor(t) {
    (this.defaults = t),
...
w.HttpStatusCode = ce;
w.default = w;
const Nn = "1680363dea7dbed736a4e7f2e9b91d8d";
w.defaults.baseURL = "https://api.themoviedb.org/3";
w.defaults.params = { api_key: Nn, language: "en-US" };
const Pn = async () => (await w.get("/trending/movie/day")).data.results,
  _n = async (e) =>
    (await w.get("/search/movie", { params: { query: e } })).data.results,
  Fn = async (e) => (await w.get(`/movie/${e}`)).data,
  Ln = async (e) => (await w.get(`/movie/${e}/credits`)).data.cast,
  Un = async (e) => (await w.get(`/movie/${e}/reviews`)).data.results,
  Bn = (e) => (e ? `https://image.tmdb.org/t/p/w500${e}` : null);
export { Fn as a, Ln as b, Un as c, Pn as f, Bn as g, _n as s };
