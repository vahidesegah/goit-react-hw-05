  ...
  const renderPaginationButtons = () => {
    ...
    if (totalPages <= visiblePages + 2) {
      ...
      if (page > visiblePages / 2 + 1) {
        buttons.push(
          <span className={css.span} key="start-ellipsis">
            ...
          </span>
        );
      }
              ...
              <ul className={css.searchMovieList}>
                {movies.map((movie) => {
                  ...
                  const rate = movie.vote_average
                    ...
                    : "Unknown";
                  const genreNames =
                    movie.genre_ids && genres.length > 0 && movie.genre_ids[0]
                    ...
                    <li key={movie.id} className={css.searchMovieItem}>
                      <Link to={`/movies/${movie.id}`}>
                        ...
                        <div className={css.searchMovieInfo}>
                          <h3 className={css.searchMovieTitle}>
                            {movie.title}
                          </h3>
                        </div>
                        <div className={css.searchMovieDetails}>
                          ...
                          <p className={css.searchMovieGenre}>
                            Genre: {genreNames}
                          </p>
                          <p className={css.searchMovieLang}>
