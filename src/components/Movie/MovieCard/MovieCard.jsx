          ...
          {memoizedMovies.map((movie) => {
            ...
            return (
              <li key={movie.id} className={css.movie_item}>
                  ...
                  <div className={css.movie_details}>
                    <div>
                      <div className={css.detail_group}>
                        <span className={css.movie_date}>
                          <strong>Date:</strong> {date}
                        </span>
                      </div>
                      <div className={css.detail_group}>
                        <span className={css.movie_rate}>
                          <strong>Rate:</strong> {rate}
                        </span>
                      </div>
                      <div className={css.detail_group}>
                        <span className={css.movie_genre}>
                          <strong>Genre:</strong> {genreNames}
                        </span>
                      </div>
                      <div className={css.detail_group}>
                        <span className={css.movie_lang}>
                ...
                >
                  {isFavorite ? (
                    <MdFavorite className={css.favoriteIcon + " active"} />
                  ) : (
